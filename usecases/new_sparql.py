...
def forcely_search(question_list,is_when):
    ...
    possible_answer_list1=search_answer_for_all_O(possible_entity_word_first,possible_relation_word_first)
    possible_answer_list2=search_answer_for_all_O(possible_entity_word_last,possible_relation_word_last)
...
def calculate_other_answer(question_list,tag_list):
    try: 
        ...
        possible_answer=[]
        possible_answer = search_answer(entity,relations)
...
def search_answer(entity,relations):
    search_loop=0
    search_flag=0
    edit_distance=1
...
def search_answer_for_all_O(entity_word,related_word):
    node_distance_dict=calculate_node_distance(entity_word)
    pred_distance_dict=calculate_pred_distance(related_word)
